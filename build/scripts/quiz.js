...
var questionText = document.getElementById("questionText"); //creating question objects - ADD question explanations property to each object.
...
var allQuestions = [question1, question2, question3, question4]; //Display the first question's text and the possible answers. 
...
document.getElementById("choice3").innerHTML = allQuestions[0].answers[2]; // variable to hold the number of the current question

var currentNum = 0; //variable to hold the users number of correct answers

var totalScore = 0; //calling the main quiz function with the first click of the navButton
...
document.getElementById("navButton").onclick = function quizFunction() {
  ...
  currentNum++; //this statement will execute if all questions have been answered AND the score is higher than the threshold
